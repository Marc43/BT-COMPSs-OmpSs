...
\lstdefinestyle{JStyle}{
	...
	frame=lines,
	classoffset=1,
	morekeywords={\#pragma, omp, oss, parallel, single, task, depend, firstprivate, priority},keywordstyle=\color{blue}\bfseries,
	otherkeywords = {\#pragma, omp, oss, parallel, single, task, depend, firstprivate, priority}
}
