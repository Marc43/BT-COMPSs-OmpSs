...
\todo{he quitado el fragmento de TARGET HOST... lo vuelvo a poner?}
...
Un añadido al proyecto ha sido soportar el tipo \texit{enum} y añadir la posibilidad de incluir cabeceras en la interfaz de una aplicación \textit{C/C++}. Para hacer esto, ha habido que hacer modifcaciones en la gramática del compilador y en la generación de código. 

\subsection{Estudio previo del rendimiento}

En la sección \todo{referenciar donde se dice que queremos hacer} se enunció el objetivo de este proyecto. En este apartado, se realiza un estudio previo del rendimiento para saber si una parte  de los objetivos propuestos. Para ello, se crean tests especializados en ver los problemas y se confirman utilizando \textit{Extrae} y \textit{Paraver}.
\bigskip
