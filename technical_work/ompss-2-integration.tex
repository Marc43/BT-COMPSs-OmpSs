...
En la sección \todo{referenciar donde se dice qué queremos hacer} se enunció el objetivo de este proyecto. En este apartado, se realiza un estudio previo del rendimiento para saber si una parte  de los objetivos propuestos están cumplidos. Para ello, se crean tests especializados para ver los problemas comentados y se verifican utilizando \textit{Extrae} y \textit{Paraver}.
\bigskip
